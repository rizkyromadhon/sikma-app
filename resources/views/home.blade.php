<x-layout :isOldPassword="$isOldPassword">
    <div id="home-page" class="bg-gray-50 py-2 sm:py-4 rounded-md" x-data
        ...
        <div class="mx-auto">
            ...
            <div class="mt-10 grid gap-4 sm:mt-12 grid-cols-1 lg:grid-cols-2 px-4 md:px-0">
                                        ...
                                        <a href="{{ route('detail.presensi', ['program_studi' => $rekap['program_studi']]) }}"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-7 text-gray-600"
                                                        fill="currentColor" viewBox="0 0 24 24">
                                                        <path fill-rule="evenodd"
                                                            d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z"
                                                            clip-rule="evenodd" />
                                                    </svg>
                                                    <p class="text-lg text-gray-600 max-w-lg pr-2 md:pr-5">
                                                        {{ $rekap['sudah'] }}</p>
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-7 text-red-600"
                                                        fill="currentColor" viewBox="0 0 24 24">
                                                        <path fill-rule="evenodd"
                                                            d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z"
                                                            clip-rule="evenodd" />
                        ...
                        <a href="/detail-presensi/${encodeURIComponent(item.program_studi)}" class="relative flex flex-col overflow-hidden lg:rounded-2xl cursor-pointer">
                                <div class="flex justify-between items-center px-5 py-3 h-[80px] md:h-0 md:py-6">
                                    ...
                                    <div class="flex items-center justify-between space-x-2 md:space-x-2">
                                        ...
                                        <p class="text-lg text-gray-600 max-w-lg pr-2 md:pr-5">${item.sudah}</p>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-7 text-red-600" fill="currentColor" viewBox="0 0 24 24">
                                            <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd"/>
                                        </svg>
                                        <p class="text-lg text-gray-600 max-w-lg pr-2 md:pr-5">${item.belum}</p>
                                    </div>
                                </div>
                        </a>
                    </div>

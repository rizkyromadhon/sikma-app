<x-layout :isOldPassword="$isOldPassword">
    <div id="home-page"
        class="bg-gray-50 dark:bg-black/50 border dark-mode-transition border-gray-200 dark:border-gray-100 py-2 sm:py-4 rounded-md"
        x-data x-bind:class="{ 'overflow-hidden': $store.loading.value }">

        <div class="mx-auto">
            <p
                class="mx-auto text-center mt-6 md:mt-6 text-3xl font-semibold tracking-tight text-balance text-gray-950 dark:text-gray-100 lg:text-4xl lg:w-120">
            ...
            <div class="mt-10 grid gap-4 sm:mt-12 grid-cols-1 lg:grid-cols-2 px-4 md:px-4">
                <div class="relative lg:row-span-2 min-h-[30rem] max-h-[50rem] flex flex-col">
                    <div
                        class="absolute inset-0 rounded-lg bg-white dark:bg-gray-900/30 dark-mode-transition border border-gray-200 dark:border-gray-100 lg:rounded-l-[1rem] h-full">
                    </div>
                    <div
                        ...
                        <div class="px-4 md:px-8 pt-8 pb-3 sm:px-10 sm:pt-8 sm:pb-2 flex flex-col h-full">
                            <p
                                class="text-xl font-semibold  tracking-tight text-gray-950 dark:text-gray-100 text-center">
                                Mahasiswa yang melakukan presensi
                            </p>
                            <div class="relative mt-5 mb-5 flex-1">
                                <div
                                    class="absolute inset-0 rounded-lg bg-white dark:bg-gray-900/40 dark-mode-transition border border-gray-200 dark:border-gray-100 lg:rounded-t-[1rem] h-full">
                                </div>
                                <div
                ...
                <div class="relative lg:row-span-2 min-h-[30rem] max-h-[50rem] flex flex-col">
                    <div
                        class="absolute inset-0 rounded-lg bg-white dark:bg-gray-900/30 dark-mode-transition border border-gray-200 dark:border-gray-100 lg:rounded-r-[1rem] h-full">
                    </div>
                    <div
                        ...
                        <div class="px-6 pt-8 pb-3 sm:px-10 sm:pt-8 sm:pb-2 flex flex-col h-full">
                            ...
                            <div id="rekap-container">
                                @foreach ($rekapPresensi as $rekap)
                                    <div class="relative mt-5">
                                        <div
                                            class="absolute inset-px rounded-lg bg-white dark:bg-gray-900/40 dark-mode-transition border border-gray-200 dark:border-gray-100 ring-1 shadow-sm ring-black/5 dark:ring-white/10 lg:rounded-lg">
                                        </div>
                            ...
                            <div
                                class="relative
                                mt-3 bg-white dark:bg-gray-900/40 dark-mode-transition border border-gray-200 dark:border-gray-100 rounded-lg">
                                <div
                                        ...
                                        <div class="flex justify-center space-x-4">
                                            <div id="total-sudah"
                                                ...
                                                <p id="total-sudah-value"
                                                    class="text-xl text-gray-600 dark:text-gray-100 max-w-lg pr-5">
            ...
            fetch('/rekap/presensi/json')
                ...
                .then(data => {
                    ...
                    data.rekapPresensi.forEach(item => {
                        container.innerHTML += `
                    <div class="relative mt-5">
                        <div class="absolute inset-px rounded-lg bg-white dark:bg-gray-900/40 dark-mode-transition border border-gray-200 dark:border-gray-100 ring-1 shadow-sm ring-black/5 dark:ring-white/10 lg:rounded-lg"></div>
                        <a href="/detail-presensi/${encodeURIComponent(item.program_studi)}" class="relative flex flex-col overflow-hidden lg:rounded-2xl cursor-pointer">
                                <div class="flex justify-between items-center px-5 py-3 h-[80px] md:h-0 md:py-6">
                                    <p class="text-lg font-medium tracking-tight text-black dark:text-gray-100">
                                        ${item.program_studi}
                                    </p>
                                    ...
                                    <div class="flex items-center justify-between space-x-2 md:space-x-2">
                                        ...
                                        <p class="text-lg text-gray-600 dark:text-gray-100 max-w-lg pr-2 md:pr-5">${item.sudah}</p>
                                        ...
                                        <p class="text-lg text-gray-600 dark:text-gray-100 max-w-lg pr-2 md:pr-5">${item.belum}</p>
                                    </div>
                                </div>
                        </a>
                    </div>

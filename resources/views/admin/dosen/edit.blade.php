...
@section('admin-content')
    <div class="container mx-auto p-4">
        <div class="bg-white shadow-sm border-b border-gray-200 px-8 py-4 mb-4 flex items-center gap-4">
            ...
            <h1 class="text-xl font-semibold text-gray-800">Edit Dosen {{ $datas->name }}</h1>
        </div>
        ...
        <div>
            <form action="{{ route('admin.dosen.update', $datas->id) }}" enctype="multipart/form-data" method="post"
                ...
                <div class="bg-white p-4 shadow w-full h-[323px]">
                        ...
                        <div class="flex flex-col gap-4 flex-1">
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="varchar" id="no_hp" name="no_hp"
                                    class="text-sm px-4 py-2 rounded border border-gray-300 shadow" placeholder="0812345678"

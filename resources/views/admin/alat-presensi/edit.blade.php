...
@section('admin-content')
    <div class="container mx-auto p-4">
        <div class="bg-white shadow-sm border-b border-gray-200 px-8 py-4 mb-4 flex items-center gap-4">
            ...
            <h1 class="text-xl font-semibold text-gray-800">Edit Alat Presensi</h1>
        </div>
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ $alat->name }}"
                                class="text-sm px-2 py-2 rounded border border-gray-300 shadow" placeholder="SIKMA-AJK">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="ssid" class="text-sm font-medium text-gray-700">SSID WiFi</label>
                            <input type="text" name="ssid" id="ssid" value="{{ $alat->ssid }}"
                                class="text-sm px-2 py-2 rounded border border-gray-300 shadow"
                                placeholder="Contoh: WiFi_Kampus">
                        </div>

                        <div class="flex flex-col gap-2">
                            <label for="wifi_password" class="text-sm font-medium text-gray-700">Password WiFi</label>
                            <input type="text" name="wifi_password" id="wifi_password" value="{{ $alat->wifi_password }}"
                                class="text-sm px-2 py-2 rounded border border-gray-300 shadow" placeholder="Password WiFi">
                        </div>
                    </div>
                    <div class="flex flex-col gap-2">
                        <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="time" name="jadwal_nyala" id="jadwal_nyala" value="{{ $alat->jadwal_nyala }}"
                                class="text-sm px-2 py-2 rounded border border-gray-300 shadow">
                        </div>

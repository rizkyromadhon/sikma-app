...
@section('admin-content')
    <div
        ...
        <h1 class="text-xl font-semibold text-gray-800 dark:text-gray-200 dark-mode-transition">Daftar Ruangan</h1>
                ...
                <tbody
                    ...
                    @forelse ($datas as $data)
                        ...
                        <div class="hidden" id="modalDeleteRuangan{{ $data->id }}">
                            ...
                            <div class="absolute inset-0 bg-gray-900/50 dark:bg-black/70 z-40"></div>
                        </div>
